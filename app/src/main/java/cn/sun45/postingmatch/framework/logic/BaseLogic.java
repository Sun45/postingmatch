package cn.sun45.postingmatch.framework.logic;
...
import cn.sun45.postingmatch.util.FileUtil;
...
public class BaseLogic {
    ...
    protected void logD(String method, String param, JSONObject obj) {
        Utils.logD(this.getClass().getName(), method, param, obj);
    }

    protected void logD(String method, String param, JSONArray obj) {
        Utils.logD(this.getClass().getName(), method, param, obj);
    }
